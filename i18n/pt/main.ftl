...
captcha-initial-state = Verifique que é um humano
...
captcha-verify-aria = Clique para verificar que é humano
captcha-verifying-aria = Verificando, por favor espere
captcha-verified-aria = Verificado
captcha-required = Por favor, verifique que é um humano
